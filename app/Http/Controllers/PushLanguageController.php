...
class PushLanguageController extends Controller
{
    public function store(Request $request)
    {
        ...
        $language->push_notification_id = $request->notificationid;
    ...
    public function update(Request $request)
    {
        ...
        $language = PushLanguage::where('id', $request->edit_notificationid)->first();
    ...
    {
        $language = PushLanguage::where('id',$request->id)->first();
        if($language){
            $language->delete();
