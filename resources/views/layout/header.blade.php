    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item dropdown d-none d-xl-inline-block">
        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          <span class="profile-text d-none d-md-inline-flex">Welcome Odda.K</span>
          <img class="img-xs rounded-circle" src="https://lh3.googleusercontent.com/a-/AOh14Ggu4BP4WamHdFcVsrDCWWQjY2iq2NKQqmV4e-ovxA=s96-c-rg-br100"  alt="Profile image" >
