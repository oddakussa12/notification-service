<div  class="modal fade"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" id="createGroupModal">
      ...
      <form id="createRecordForm" method="POST">
        ...
        <div>
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" style="margin-top:5px;" name="phone" class="form-control form-control-sm" id="colFormLabelSm" placeholder="Group name...">
                </div>
            </div>
        </div>
