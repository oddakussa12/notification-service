<div  class="modal fade" id="addPushNotificationLanguaModal"   tabindex="-1" aria-hidden="true" >
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="background-color:#006699;">
          <h5 class="modal-title" style="color:white;">Add Push Notification Language</h5>
          <button type="button"  class="btn-close" data-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body" style="background-color: white;">
        {{-- below span hold form validation messages --}}
        <span id="create_push_noti_lang_form_result"></span>
        <form id="createPushLanguageForm" method="POST">
              @csrf
              <div>
              ...
              <div style="text-align:right;margin-top:10px;">
                  ...
                  <button type="submit" id="createPushLangBtn" style="width:80px;" class="btn btn-primary btn-sm" value="Create">Create</button>
              </div>
          </form>
