                ...
                <div class="col-lg-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <small for="account_name" style="font-size: 16px;">Notification template</small>
                                    <select class="form-control" style="height:40px; padding:5px;border-radius:5px;margin-top:5px;font-size:16px;"
                                        name="push_notification_id">
                                        <option selected disabled>Select push notification</option>
                                        @foreach($push_notifications as $message)
                                            <option value="{{$message->id}}" style="font-size: 16px;">{{$message->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
